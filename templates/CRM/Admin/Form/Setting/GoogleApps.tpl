{*
 ...
 +--------------------------------------------------------------------------+
*}
{* this template is used for setting-up the Google Apps Sync extension *}
<div class="form-item">
<fieldset><legend>{ts}Setup{/ts}</legend>
<div class="crm-block crm-form-block crm-sync-googleapps-form-block">
<div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
  <table class="form-layout-compressed">
    <tr class="crm-sync-googleapps-form-block">
...
{/if}
    <tr class="crm-sync-googleapps-form-block">
      ...
      <td>{$form.group.html} {help id="group"}</td>
    </tr>
  </table>
...
{else}
  ...
  <p>{ts}Total contacts synchronized{/ts}: {$job.synced}</p>
  <p>{ts}Total contacts processed via Google API{/ts}: {$job.processed}</p>
